...
public class MainActivity extends AndSketch implements AndGLView.IGLFunctionEvent, OnItemClickListener{
...
//			String[] str = {"本多","笠原","里井"};
			// ListViewを作成
			ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, modelNames);
...
//				}
		...
		synchronized private KGLModelData getCreateModel(GL10 gl, int id){
			...
			try {
				...
				KGLModelData data = KGLModelData.createGLModel(gl, null, modelPath, modelNames[id] + ".mqo", 0.03f);
				return data;
